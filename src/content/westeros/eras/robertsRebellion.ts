...
export const robertsRebellionCharacters: CanonCharacter[] = [
  {
    ...
    birthYear: 263,
    age: 19,
    coreStats: { STR: 14, AGI: 12, END: 16, INT: 13, WIL: 18, CHA: 12 },
    talentIds: ["honorable", "born-leader", "loyal"],
    skills: { "Chỉ Huy": 15, "Cận Chiến (Kiếm)": 14, "Cưỡi Ngựa": 12 },
    equipment: [{ slot: "Tay Phải", ten: "Ice", phamChat: "Thép Valyria", thuocTinh: { "Sát Thương": 30 }, moTa: "Thanh trọng kiếm thép Valyria của Nhà Stark." }],
    items: [],
    gold: 2000,
    startingHookIds: ["stark-rebellion"],
  ...
  },
  {
    ...
    birthYear: 217,
    age: 65,
    coreStats: { STR: 10, AGI: 8, END: 12, INT: 16, WIL: 16, CHA: 15 },
  ...
  },
  {
    ...
    birthYear: 238,
    age: 44,
    coreStats: { STR: 12, AGI: 10, END: 13, INT: 15, WIL: 14, CHA: 14 },
  ...
  },
  {
    ...
    birthYear: 242,
    age: 40,
    coreStats: { STR: 13, AGI: 12, END: 14, INT: 18, WIL: 20, CHA: 16 },
  ...
  },
  {
    ...
    deathYear: 283,
    age: 23,
    coreStats: { STR: 15, AGI: 16, END: 15, INT: 16, WIL: 14, CHA: 18 },
  ...
  },
  {
    ...
    deathYear: 283,
    age: 38,
    coreStats: { STR: 8, AGI: 8, END: 8, INT: 12, WIL: 6, CHA: 10 },
  ...
  },
  {
    ...
    birthYear: 266,
    age: 16,
    coreStats: { STR: 16, AGI: 18, END: 15, INT: 12, WIL: 12, CHA: 18 },
  ...
  },
  {
    ...
    birthYear: 237,
    age: 45,
    coreStats: { STR: 16, AGI: 16, END: 18, INT: 12, WIL: 18, CHA: 15 },
  ...
  },
  {
    ...
    deathYear: 283,
    age: 27,
    coreStats: { STR: 18, AGI: 18, END: 18, INT: 14, WIL: 18, CHA: 16 },
    talentIds: ["prodigy", "honorable", "chivalrous"],
    skills: { "Cận Chiến (Kiếm)": 20, "Cưỡi Ngựa": 16 },
    equipment: [{ slot: "Tay Phải", ten: "Dawn", phamChat: "Vô Giá", thuocTinh: { "Sát Thương": 35 }, moTa: "Thanh kiếm rèn từ tâm một ngôi sao băng, không kém gì Thép Valyria." }],
    items: [],
    gold: 300,
    startingHookIds: [],
    personalHooks: [
  ...
  },
  {
    ...
    birthYear: 256,
    age: 26,
    coreStats: { STR: 12, AGI: 10, END: 14, INT: 12, WIL: 10, CHA: 14 },
  ...
  },
  {
    ...
    birthYear: 244,
    age: 38,
    coreStats: { STR: 16, AGI: 14, END: 16, INT: 15, WIL: 18, CHA: 12 },
    talentIds: ["strict", "fearsome-warrior", "strategic-mind"],
    skills: { "Chỉ Huy": 18, "Cận Chiến (Kiếm)": 16, "Chiến Lược": 18 },
    equipment: [{ slot: "Tay Phải", ten: "Heartsbane", phamChat: "Thép Valyria", thuocTinh: { "Sát Thương": 25 }, moTa: "Thanh trọng kiếm Thép Valyria của Nhà Tarly." }],
    items: [],
    gold: 800,
    startingHookIds: [],
    personalHooks: [
  ...
  },
  {
    ...
    birthYear: 247,
    age: 35,
    coreStats: { STR: 8, AGI: 8, END: 8, INT: 18, WIL: 16, CHA: 15 },
  ...
  },
  {
    ...
    birthYear: 258,
    age: 24,
    coreStats: { STR: 14, AGI: 18, END: 15, INT: 16, WIL: 15, CHA: 16 },
  ...
  },
  {
    ...
    birthYear: 255,
    age: 27,
    coreStats: { STR: 14, AGI: 12, END: 15, INT: 10, WIL: 16, CHA: 12 },
  ...
  },
  {
    ...
    birthYear: 264,
    age: 18,
    coreStats: { STR: 15, AGI: 10, END: 18, INT: 14, WIL: 20, CHA: 8 },
  ...
  },
  {
    ...
    birthYear: 277,
    age: 5,
    coreStats: { STR: 5, AGI: 6, END: 6, INT: 10, WIL: 8, CHA: 14 },
