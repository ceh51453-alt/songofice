...
export const robertsRebellionCharacters: CanonCharacter[] = [
  {
    id: "eddard-stark",
    origin: "Con trai thứ Rickard và Lyarra Stark, được Jon Arryn nuôi dạy ở Eyrie cùng Robert; trở thành Lord of Winterfell sau cái chết của Brandon và Rickard.", culture: "Người Đầu Tiên vùng Bắc", bloodline: "Nhà Stark", continent: "Westeros",
    appearance: "Tóc nâu, mặt dài và mắt xám của nhà Stark; vóc người gầy, nghiêm nghị hơn Robert.",
    name: "Eddard Stark",
...
father: "rickard-stark",
  ...
  {
    id: "jon-arryn",
    origin: "Lãnh chúa Eyrie và Warden of the East, nuôi dạy Robert Baratheon và Eddard Stark; người khởi đầu cuộc nổi dậy khi Aerys đòi giao nộp họ.", culture: "Người Vale", bloodline: "Nhà Arryn", continent: "Westeros",
    appearance: "Một lãnh chúa cao tuổi, tóc bạc và dáng gầy; nguồn canon không ghi nhận mô tả chi tiết hơn.",
    name: "Jon Arryn",
    tuocVi: "Đại Lãnh Chúa",
    house: "Arryn",
...
father: "jasper-arryn",
  ...
  {
    id: "hoster-tully",
    origin: "Lãnh chúa Riverrun và Lord Paramount of the Trident, cha Catelyn, Lysa và Edmure; liên minh với Stark và Arryn qua hôn nhân.", culture: "Người Riverlands", bloodline: "Nhà Tully", continent: "Westeros",
    appearance: "Người đàn ông đã lớn tuổi, tóc đỏ nâu kiểu Tully; không có mô tả ngoại hình canon chi tiết.",
    name: "Hoster Tully",
    tuocVi: "Đại Lãnh Chúa",
    house: "Tully",
...
spouse: "minisa-whent",
  ...
  {
    id: "tywin-lannister",
    origin: "Con trai Tytos và Jeyne Marbrand, Lãnh chúa Casterly Rock, Warden of the West và từng là Hand of the King.", culture: "Người miền Tây", bloodline: "Nhà Lannister", continent: "Westeros",
    appearance: "Cao, gầy, vai rộng; đầu hói, có tóc mai vàng và mắt xanh lục nhạt.",
...
father: "tytos-lannister",
...
},
  {
    ...
    origin: "Con trai trưởng Aerys II và Rhaella, Thái tử Bảy Vương Quốc, chồng Elia Martell và cha Rhaenys cùng Aegon.", culture: "Valyria hậu duệ", bloodline: "Nhà Targaryen", continent: "Westeros",
    appearance: "Cao, đẹp, tóc bạc-vàng dài và mắt tím sẫm; vừa là nhạc sĩ tài hoa vừa là chiến binh.",
  ...
  {
    id: "aerys-ii",
    origin: "Con trai Jaehaerys II và Shaera Targaryen, vị vua cuối cùng của triều Targaryen trước cuộc nổi dậy.", culture: "Valyria hậu duệ", bloodline: "Nhà Targaryen", continent: "Westeros",
    appearance: "Cuối đời gầy gò, tóc và móng tay dài rối, mắt tím hoang dại; hầu như không tắm rửa hay cắt tóc.",
...
spouse: "rhaella-targaryen",
  ...
  {
    id: "jaime-lannister",
    origin: "Con trai Tywin và Joanna, em song sinh Cersei; Kingsguard trẻ nhất lịch sử và bị giữ ở King's Landing khi cha kéo quân.", culture: "Người miền Tây", bloodline: "Nhà Lannister", continent: "Westeros",
    appearance: "Cao lớn, tóc vàng xoăn, mắt xanh lục; ở giai đoạn này vẫn là kiếm sĩ trẻ đầy tự tin với cả hai tay.",
  ...
  {
    id: "barristan-selmy",
    origin: "Hiệp sĩ Nhà Selmy từ Harvest Hall, Lord Commander Kingsguard phục vụ Aerys II và sau này Robert I.", culture: "Người Bão Tố", bloodline: "Nhà Selmy", continent: "Westeros",
    appearance: "Hiệp sĩ lớn tuổi tóc bạc, vóc người vẫn thẳng và rắn rỏi; từng được gọi là Barristan the Bold.",
  ...
  {
    id: "arthur-dayne",
    origin: "Hiệp sĩ Nhà Dayne ở Starfall, Kingsguard của Aerys II và thân cận Rhaegar, giữ Tower of Joy cuối chiến tranh.", culture: "Dornish", bloodline: "Nhà Dayne", continent: "Westeros",
    appearance: "Hiệp sĩ trẻ tóc vàng sẫm, mắt tím; mang Dawn, thanh kiếm trắng của Nhà Dayne.",
    name: "Arthur Dayne",
    tuocVi: "Hiệp Sĩ",
    house: "Dayne",
  ...
  {
    id: "mace-tyrell",
    origin: "Con trai Luthor Tyrell và Olenna Redwyne, Lord of Highgarden và Warden of the South; giữ Storm's End cho Targaryen.", culture: "Người Reach", bloodline: "Nhà Tyrell và Redwyne", continent: "Westeros",
    appearance: "Quý tộc to lớn, tự mãn và ăn mặc xa hoa; nguồn canon không có chân dung chi tiết hơn.",
    name: "Mace Tyrell",
    tuocVi: "Đại Lãnh Chúa",
    house: "Tyrell",
...
father: "luthor-tyrell",
  ...
  {
    id: "randyll-tarly",
    origin: "Lãnh chúa Horn Hill, chư hầu Tyrell và tướng lĩnh chiến thắng Robert tại Ashford trước khi Mace chọn đầu hàng.", culture: "Người Reach", bloodline: "Nhà Tarly", continent: "Westeros",
    appearance: "Một chiến binh cứng rắn, khắc khổ; nguồn canon không nêu mô tả ngoại hình chi tiết.",
    name: "Randyll Tarly",
    tuocVi: "Lãnh Chúa",
    house: "Tarly",
  ...
  {
    id: "doran-martell",
    origin: "Hoàng tử Dorne, con trai Princess of Dorne, anh trai Elia và Oberyn; giữ Dorne cho Targaryen trong cuộc chiến.", culture: "Dornish Rhoynar", bloodline: "Nhà Nymeros Martell", continent: "Westeros",
    appearance: "Ở tuổi trẻ khỏe mạnh hơn giai đoạn sau; nguồn canon không có chân dung tuổi trẻ chi tiết.",
    name: "Doran Martell",
    tuocVi: "Đại Lãnh Chúa",
    house: "Martell",
...
spouse: "mellario-of-norvos",
  ...
  {
    id: "oberyn-martell",
    origin: "Em trai Doran và Elia Martell, hoàng tử Dorne nổi tiếng với học vấn, đấu kiếm và những chuyến phiêu lưu Essos.", culture: "Dornish Rhoynar", bloodline: "Nhà Nymeros Martell", continent: "Westeros",
    appearance: "Gầy, uyển chuyển, da ô liu, tóc đen và mắt đen láy; nụ cười quyến rũ nhưng nguy hiểm.",
    name: "Oberyn Martell",
    tuocVi: "Vương Thân",
    house: "Martell",
    role: "Rắn Hổ Mang Đỏ",
  ...
  {
    id: "balon-greyjoy",
    origin: "Con trai Quellon Greyjoy và người thừa kế Pyke năm 282 AC; chưa là người khởi xướng cuộc nổi loạn 289 AC.", culture: "Người Sắt", bloodline: "Nhà Greyjoy", continent: "Westeros",
    appearance: "Tóc đen pha xám, gương mặt khắc khổ và vóc người gầy; nguồn canon không mô tả chi tiết ở đúng năm này.",
    name: "Balon Greyjoy",
    tuocVi: "Quốc Vương",
    house: "Greyjoy",
...
},
  {
    ...
    origin: "Con trai thứ Steffon và Cassana Baratheon, em Robert và anh Renly; bảo vệ Storm's End suốt cuộc vây hãm.", culture: "Người Bão Tố", bloodline: "Nhà Baratheon", continent: "Westeros",
    appearance: "Gầy, cứng nhắc, tóc đen và mắt xanh lam; mặt dài, nghiêm khắc, ít biểu lộ cảm xúc.",
    name: "Stannis Baratheon",
    tuocVi: "Lãnh Chúa",
    house: "Baratheon",
    role: "Chỉ Huy Storm's End",
    legalStatus: "courtier",
    residenceIds: ["the-stormlands-seat"],
    claimRegionIds: [],
    religion: "Thất Diện Thần",
  ...
  {
    id: "renly-baratheon",
    origin: "Con trai út Steffon và Cassana Baratheon, em Robert và Stannis; còn là một đứa trẻ trong Cuộc Nổi loạn Robert.", culture: "Người Bão Tố", bloodline: "Nhà Baratheon", continent: "Westeros",
    appearance: "Cậu bé tóc đen, mắt xanh và được cho là rất giống Robert khi trưởng thành.",
...
},
  {
    ...
    origin: "Em gái Doran và Oberyn Martell, vợ Rhaegar Targaryen, mẹ Rhaenys và Aegon; ở King's Landing trong giai đoạn cuối chiến tranh.", culture: "Dornish Rhoynar", bloodline: "Nhà Nymeros Martell", continent: "Westeros", appearance: "Mảnh khảnh, da ô liu, tóc đen và mắt nâu; sức khỏe yếu sau những lần sinh nở.",
...
},
  {
    ...
    origin: "Con gái Jaehaerys II và Shaera, em gái kiêm vợ Aerys II, mẹ Rhaegar, Viserys và Daenerys; được đưa tới Dragonstone lúc triều đình sụp đổ.", culture: "Valyria hậu duệ", bloodline: "Nhà Targaryen", continent: "Westeros", appearance: "Tóc bạc-vàng và mắt tím, dung mạo suy kiệt vì nhiều lần sảy thai, thai chết lưu và bạo hành.",
...
},
  {
    ...
    origin: "Con gái cả Hoster Tully và Minisa Whent; ban đầu được hứa hôn với Brandon Stark, sau đó cưới Eddard để củng cố liên minh.", culture: "Người Riverlands", bloodline: "Nhà Tully và Whent", continent: "Westeros", appearance: "Tóc đỏ nâu dày và mắt xanh lam, vẻ đẹp thanh lịch kiểu Riverrun.",
...
},
  {
    ...
    origin: "Con gái Hoster Tully và Minisa Whent; được gả cho Jon Arryn để đưa Riverrun vào liên minh nổi dậy.", culture: "Người Riverlands", bloodline: "Nhà Tully và Whent", continent: "Westeros", appearance: "Tóc đỏ nâu và mắt xanh nhạt kiểu Tully; còn rất trẻ trong cuộc hôn nhân chính trị với Jon Arryn.",
...
},
  {
    ...
    origin: "Lãnh chúa Dreadfort, chư hầu Stark; tham gia quân miền Bắc trong cuộc nổi dậy trước khi phản bội Robb nhiều năm sau.", culture: "Người Đầu Tiên vùng Bắc", bloodline: "Nhà Bolton", continent: "Westeros", appearance: "Da nhợt nhạt, mắt nhạt gần như không màu và giọng nói nhỏ nhẹ, lạnh lẽo.",
...
},
  {
    ...
    origin: "Lãnh chúa Griffin's Roost, bạn thân của Rhaegar và Hand of the King của Aerys II; thất bại trước Robert ở Stoney Sept.", culture: "Người Bão Tố", bloodline: "Nhà Connington", continent: "Westeros", appearance: "Tóc đỏ nâu, mắt xanh và dáng người trẻ, kiêu hãnh; về sau sống lưu vong dưới tên Griff.",
...
},
  {
    ...
    origin: "Con trai thứ Aerys II và Rhaella, em Rhaegar; còn là hoàng tử nhỏ ở Dragonstone khi triều đại của gia đình tan rã.", culture: "Valyria hậu duệ", bloodline: "Nhà Targaryen", continent: "Westeros", appearance: "Cậu bé tóc bạc-vàng và mắt tím, ngoại hình Valyria rõ rệt.",
...
},
  {
    ...
    origin: "Lord Commander Kingsguard của Aerys II, thành viên Nhà Hightower ở Oldtown và người chết tại Tower of Joy.", culture: "Người Reach", bloodline: "Nhà Hightower", continent: "Westeros", appearance: "Hiệp sĩ tóc trắng, vóc dáng cao lớn và uy nghiêm, nổi tiếng với biệt danh White Bull.",
...
},
  {
    ...
    origin: "Hiệp sĩ Kingsguard của Aerys II, thành viên Nhà Whent của Harrenhal và người chết tại Tower of Joy.", culture: "Người Riverlands", bloodline: "Nhà Whent", continent: "Westeros", appearance: "Không có mô tả ngoại hình canon chi tiết; thường xuất hiện trong áo giáp trắng của Kingsguard.",
...
},
  {
    ...
    origin: "Hiệp sĩ Nhà Lonmouth, bạn thân của Rhaegar Targaryen và được gọi là Knight of Skulls.", culture: "Người Bão Tố", bloodline: "Nhà Lonmouth", continent: "Westeros", appearance: "Không có mô tả ngoại hình canon xác thực; biệt danh gắn với biểu tượng đầu lâu của Nhà Lonmouth.",
...
},
  {
    ...
    origin: "Con trai trưởng Steffon và Cassana Baratheon, được Jon Arryn nuôi dạy ở Eyrie; Lord of Storm's End và lãnh đạo cuộc nổi dậy chống Aerys II.", culture: "Người Bão Tố", bloodline: "Nhà Baratheon; dòng Durrandon qua nữ hệ", continent: "Westeros", appearance: "Cao lớn, vai rộng, tóc đen và mắt xanh; ở tuổi 20 còn là chiến binh vạm vỡ với cây búa chiến khổng lồ.",
...
},
  {
    ...
    origin: "Lãnh chúa Storm's End, cha Robert, Stannis và Renly; chết cùng vợ Cassana khi Windproud chìm năm 278 AC.", culture: "Người Bão Tố", bloodline: "Nhà Baratheon", continent: "Westeros", appearance: "Không có mô tả ngoại hình canon xác thực.",
...
},
  {
    ...
    origin: "Quý nữ Estermont, vợ Steffon Baratheon và mẹ Robert, Stannis, Renly; chết cùng chồng khi Windproud đắm năm 278 AC.", culture: "Người Bão Tố", bloodline: "Nhà Estermont; kết hôn vào Baratheon", continent: "Westeros", appearance: "Không có mô tả ngoại hình canon xác thực.",
...
},
  {
    ...
    origin: "Sinh ra là Selyse Florent, con gái Nhà Florent ở Brightwater Keep; hôn nhân với Stannis thuộc giai đoạn sau cuộc nổi loạn.", culture: "Người Reach", bloodline: "Nhà Florent", continent: "Westeros", appearance: "Tai to, mắt xanh nhạt, tóc nâu; vẻ mặt nghiêm khắc và hơi gầy gò.",
...
},
  {
    ...
    origin: "Lãnh chúa Winterfell và Warden of the North, cha Brandon, Eddard, Lyanna và Benjen; bị Aerys II thiêu chết năm 282 AC.", culture: "Người Đầu Tiên vùng Bắc", bloodline: "Nhà Stark", continent: "Westeros", appearance: "Người đàn ông tóc nâu, mặt dài và mắt xám kiểu Stark; nguồn canon không chi tiết hơn.",
...
},
  {
    ...
    origin: "Cô họ và vợ Rickard Stark, mẹ của Brandon, Eddard, Lyanna và Benjen; qua đời trước sự kiện chính của cuộc nổi loạn.", culture: "Người Đầu Tiên vùng Bắc", bloodline: "Nhà Stark", continent: "Westeros", appearance: "Không có mô tả ngoại hình canon xác thực.",
...
},
  {
    ...
    origin: "Trưởng nam Rickard Stark và người thừa kế Winterfell, hứa hôn với Catelyn Tully; bị Aerys II xử tử cùng cha năm 282 AC.", culture: "Người Đầu Tiên vùng Bắc", bloodline: "Nhà Stark", continent: "Westeros", appearance: "Người đàn ông cao lớn, tóc nâu, mắt xám; nóng nảy và được gọi là Wild Wolf.",
...
},
  {
    ...
    origin: "Con gái Rickard và Lyarra Stark, em Eddard; hứa hôn Robert nhưng biến mất cùng Rhaegar, trở thành tâm điểm chính trị của cuộc nổi dậy.", culture: "Người Đầu Tiên vùng Bắc", bloodline: "Nhà Stark", continent: "Westeros", appearance: "Tóc nâu, mặt dài, mắt xám kiểu Stark; được Ned mô tả là xinh đẹp theo cách hoang dã, có máu nóng.",
...
},
  {
    ...
    origin: "Con trai út Rickard và Lyarra Stark, em Eddard; còn ở Winterfell trong cuộc nổi loạn trước khi gia nhập Tuần Đêm.", culture: "Người Đầu Tiên vùng Bắc", bloodline: "Nhà Stark", continent: "Westeros", appearance: "Tóc nâu, mắt xám và gương mặt dài kiểu Stark; nguồn canon không chi tiết hơn ở tuổi trẻ.",
...
},
  {
    ...
    origin: "Cha của Jon Arryn; đã qua đời trước cuộc nổi loạn, nên hồ sơ này chỉ phục vụ quan hệ gia phả.", culture: "Người Vale", bloodline: "Nhà Arryn", continent: "Westeros", appearance: "Không xác minh.",
...
},
  {
    ...
    origin: "Phu nhân Nhà Whent, vợ quá cố Hoster Tully và mẹ Catelyn, Lysa, Edmure; đã qua đời trước cuộc nổi loạn.", culture: "Người Riverlands", bloodline: "Nhà Whent; kết hôn vào Tully", continent: "Westeros", appearance: "Không có mô tả ngoại hình canon xác thực.",
...
},
  {
    ...
    origin: "Con trai duy nhất Hoster Tully và Minisa Whent, người thừa kế Riverrun; còn là thiếu niên trong Cuộc nổi loạn Robert.", culture: "Người Riverlands", bloodline: "Nhà Tully và Whent", continent: "Westeros", appearance: "Tóc đỏ nâu, mắt xanh lam và khuôn mặt đẹp trai kiểu Tully.",
...
},
  {
    ...
    origin: "Lãnh chúa Casterly Rock trước Tywin, cha Tywin, Kevan, Genna và các con khác; mất năm 267 AC, trước cuộc nổi loạn.", culture: "Người miền Tây", bloodline: "Nhà Lannister", continent: "Westeros", appearance: "Người đàn ông béo tốt, thân thiện và dễ tin người theo các ghi chép về triều đại ông.",
...
},
  {
    ...
    origin: "Sinh ra là Joanna Lannister, em họ kiêm vợ Tywin và mẹ Cersei, Jaime, Tyrion; chết khi sinh Tyrion năm 273 AC.", culture: "Người miền Tây", bloodline: "Nhà Lannister", continent: "Westeros", appearance: "Nổi tiếng vì vẻ đẹp và sự duyên dáng; nguồn canon không có chân dung chi tiết đáng tin cậy.",
...
},
  {
    ...
    origin: "Con gái Tywin và Joanna, chị song sinh Jaime; còn là thiếu nữ tại Casterly Rock trong cuộc nổi loạn trước khi cưới Robert.", culture: "Người miền Tây", bloodline: "Nhà Lannister", continent: "Westeros", appearance: "Tóc vàng óng, mắt xanh lục và sắc đẹp nổi bật, thường được cho là giống Jaime đến mức đáng kinh ngạc.",
...
},
  {
    ...
    origin: "Con trai út Tywin và Joanna, sinh năm 273 AC khiến mẹ qua đời; được nuôi ở Casterly Rock trong sự khinh miệt của cha.", culture: "Người miền Tây", bloodline: "Nhà Lannister", continent: "Westeros", appearance: "Dáng lùn, tóc vàng gần trắng, mắt một xanh một đen; chân ngắn và trán cao đặc trưng.",
...
},
  {
    ...
    origin: "Chồng Olenna Redwyne và cha Mace Tyrell, Lord of Highgarden trước Mace; mất vì ngã ngựa trong cuộc săn trước cuộc nổi loạn.", culture: "Người Reach", bloodline: "Nhà Tyrell", continent: "Westeros", appearance: "Không có mô tả ngoại hình canon xác thực.",
...
},
  {
    ...
    origin: "Sinh ra là Olenna Redwyne, góa phụ Luthor Tyrell và mẹ Mace; tiếng nói chính trị sắc bén của Highgarden.", culture: "Người Reach", bloodline: "Nhà Redwyne; kết hôn vào Tyrell", continent: "Westeros", appearance: "Bà lão nhỏ người, tóc bạc, mắt sáng và lưỡi sắc như gai hồng.",
...
},
  {
    ...
    origin: "Quý nữ Nhà Hightower ở Oldtown, vợ Mace Tyrell và mẹ Willas, Garlan, Loras, Margaery.", culture: "Người Reach", bloodline: "Nhà Hightower; kết hôn vào Tyrell", continent: "Westeros", appearance: "Không có mô tả ngoại hình canon xác thực.",
...
},
  {
    ...
    origin: "Con trai cả Mace Tyrell và Alerie Hightower, người thừa kế Highgarden; còn nhỏ trong cuộc nổi loạn.", culture: "Người Reach", bloodline: "Nhà Tyrell và Hightower", continent: "Westeros", appearance: "Nguồn canon không mô tả rõ ngoại hình thời thơ ấu; khi trưởng thành bị thương chân trong cuộc cưỡi ngựa với Oberyn.",
...
},
  {
    ...
    origin: "Con trai thứ Mace Tyrell và Alerie Hightower; còn nhỏ, chưa phải hiệp sĩ ở thời điểm 282 AC.", culture: "Người Reach", bloodline: "Nhà Tyrell và Hightower", continent: "Westeros", appearance: "Nguồn canon không mô tả ngoại hình thời thơ ấu; khi lớn lên ông cao lớn và mang nét Tyrell.",
...
},
  {
    ...
    origin: "Con trai thứ ba Mace Tyrell và Alerie Hightower, sinh khoảng năm 282 AC; chưa phải hiệp sĩ ở mốc đầu era.", culture: "Người Reach", bloodline: "Nhà Tyrell và Hightower", continent: "Westeros", appearance: "Chưa có mô tả canon riêng ở thời thơ ấu; về sau tóc nâu xoăn, mắt nâu và rất đẹp trai.",
...
},
  {
    ...
    origin: "Con gái Mace Tyrell và Alerie Hightower, sinh sau mốc mở đầu 282 AC; hồ sơ chỉ dùng để giữ liên kết gia phả tương lai.", culture: "Người Reach", bloodline: "Nhà Tyrell và Hightower", continent: "Westeros", appearance: "Không áp dụng ở đầu era; khi lớn lên có tóc nâu xoăn, mắt nâu và nụ cười ấm áp.",
...
},
  {
    ...
    origin: "Lord Reaper of Pyke, cha Balon, Euron, Victarion, Aeron; cố cải cách Quần Đảo Sắt theo hướng giao thương với lục địa trước khi chết năm 289 AC.", culture: "Người Sắt", bloodline: "Nhà Greyjoy", continent: "Westeros", appearance: "Không có mô tả ngoại hình canon xác thực.",
...
},
  {
    ...
    origin: "Con trai Quellon Greyjoy và em Balon; một thuyền trưởng Người Sắt trước khi bị Balon đày khỏi đảo trong những năm sau.", culture: "Người Sắt", bloodline: "Nhà Greyjoy", continent: "Westeros", appearance: "Tóc đen phủ vai, râu sẫm; một mắt xanh biếc còn mắt kia bị che bằng miếng bịt màu đen.",
...
},
  {
    ...
    origin: "Con trai Quellon Greyjoy, em Balon; thủy thủ và chiến binh Người Sắt trước khi trở thành Lord Captain of the Iron Fleet.", culture: "Người Sắt", bloodline: "Nhà Greyjoy", continent: "Westeros", appearance: "Rất to lớn, tóc đen, râu rậm và mắt xám thép.",
...
},
  {
    ...
    origin: "Con trai út Quellon Greyjoy, em Balon; ở năm 282 còn trẻ, chưa trở thành mục sư 'Damphair' của Drowned God.", culture: "Người Sắt", bloodline: "Nhà Greyjoy", continent: "Westeros", appearance: "Tóc đen và râu đen; mô tả tóc ướt, áo thô thuộc về thời kỳ tu hành sau này.",
...
},
  {
    ...
    origin: "Quý nữ Nhà Harlaw, vợ Balon Greyjoy và mẹ Rodrik, Maron, Asha, Theon; suy sụp sau khi hai con trai lớn chết năm 289 AC.", culture: "Người Sắt", bloodline: "Nhà Harlaw; kết hôn vào Greyjoy", continent: "Westeros", appearance: "Không có mô tả ngoại hình canon xác thực.",
...
},
  {
    ...
    origin: "Con trai cả Balon Greyjoy và Alannys Harlaw; chết cùng em Maron trong cuộc nổi loạn Greyjoy năm 289 AC.", culture: "Người Sắt", bloodline: "Nhà Greyjoy và Harlaw", continent: "Westeros", appearance: "Không có mô tả ngoại hình canon xác thực.",
...
},
  {
    ...
    origin: "Con trai thứ Balon Greyjoy và Alannys Harlaw; chết cùng anh Rodrik trong cuộc nổi loạn Greyjoy năm 289 AC.", culture: "Người Sắt", bloodline: "Nhà Greyjoy và Harlaw", continent: "Westeros", appearance: "Không có mô tả ngoại hình canon xác thực.",
...
},
  {
    ...
    origin: "Con gái Balon Greyjoy và Alannys Harlaw, sinh khoảng năm 275 AC; là một bé gái ở đầu cuộc nổi loạn Robert, không phải trẻ sơ sinh.", culture: "Người Sắt", bloodline: "Nhà Greyjoy và Harlaw", continent: "Westeros", appearance: "Không có mô tả canon riêng ở tuổi nhỏ; khi trưởng thành cao, tóc đen ngắn và có dáng thuyền trưởng.",
...
},
  {
    ...
    origin: "Con trai út còn sống của Balon Greyjoy và Alannys Harlaw, sinh khoảng năm 280 AC; còn là trẻ nhỏ trước khi bị đưa tới Winterfell làm con tin năm 289 AC.", culture: "Người Sắt", bloodline: "Nhà Greyjoy và Harlaw", continent: "Westeros", appearance: "Không có mô tả canon riêng lúc nhỏ; khi trưởng thành tóc đen, dáng mảnh và gương mặt sắc.",
...
},
  {
    ...
    origin: "Con gái Rhaegar Targaryen và Elia Martell, chị Aegon; ở King's Landing với mẹ trong giai đoạn cuối cuộc chiến.", culture: "Valyria hậu duệ; gắn với Dorne", bloodline: "Nhà Targaryen và Nymeros Martell", continent: "Westeros", appearance: "Cô bé có tóc đen và mắt tím; yêu thích con mèo đen tên Balerion.",
...
},
  {
    ...
    origin: "Con trai Rhaegar Targaryen và Elia Martell, sinh khoảng năm 281/282 AC; bị Gregor Clegane giết khi King's Landing thất thủ năm 283 AC.", culture: "Valyria hậu duệ; gắn với Dorne", bloodline: "Nhà Targaryen và Nymeros Martell", continent: "Westeros", appearance: "Trẻ sơ sinh; không có mô tả ngoại hình canon chi tiết.",
...
},
  {
    ...
    origin: "Quý nữ Norvos, vợ Doran Martell và mẹ Arianne, Quentyn, Trystane; về sau rời Dorne trở lại quê nhà.", culture: "Norvoshi", bloodline: "Không xác minh; kết hôn vào Nymeros Martell", continent: "Essos", appearance: "Không có mô tả ngoại hình canon xác thực.",
...
},
  {
    ...
    origin: "Con gái cả Doran Martell và Mellario of Norvos, sinh khoảng năm 276 AC; là người thừa kế Sunspear theo luật Dorne.", culture: "Dornish Rhoynar", bloodline: "Nhà Nymeros Martell và Norvos", continent: "Westeros", appearance: "Chưa có mô tả canon riêng ở tuổi nhỏ; khi trưởng thành da ô liu, tóc đen xoăn và mắt nâu sẫm.",
...
},
  {
    ...
    origin: "Con trai Doran Martell và Mellario of Norvos, sinh khoảng năm 281 AC; còn là trẻ nhỏ ở đầu era.", culture: "Dornish Rhoynar", bloodline: "Nhà Nymeros Martell và Norvos", continent: "Westeros", appearance: "Không có mô tả canon riêng ở tuổi nhỏ; khi trưởng thành tóc nâu, mắt nâu và dáng người bình thường.",
    birthYear: 281, age: 1, coreStats: { "Sức Mạnh": 2, "Nhanh Nhẹn": 2, "Thể Chất": 2, "Trí Tuệ": 2, "Tinh Tường": 2, "Uy Tín": 2 },
    năngLực: { "Võ Lực": 10, "Thống Soái": 10, "Trí Mưu": 10, "Ngoại Giao": 10 },
    talentIds: [], skills: {}, equipment: [], items: [], gold: 0,
    startResources: {
...
},
  {
    ...
    origin: "Con trai út Doran Martell và Mellario of Norvos, sinh sau mốc 282 AC; hồ sơ chỉ giữ liên kết gia phả tương lai.", culture: "Dornish Rhoynar", bloodline: "Nhà Nymeros Martell và Norvos", continent: "Westeros", appearance: "Không áp dụng ở đầu era; khi lớn lên là cậu bé có tóc nâu và mắt nâu.",
