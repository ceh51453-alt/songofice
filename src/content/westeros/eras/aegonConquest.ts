...
father: "lannister-father-loren",
    ...
    relationshipDetails: {
      ...
      "aegon-targaryen": { type: "Kẻ Thù", trust: 0, affinity: 0, detail: "Loren quỳ gối trước Aegon sau Cánh Đồng Lửa. Lựa chọn giữa tôn nghiêm và sống còn." }
    }
},
  {
    id: "mern-ix-gardener",
    ...
    relationshipDetails: {
      ...
      "aegon-targaryen": { type: "Kẻ Thù", trust: 0, affinity: 0, detail: "Mern dẫn đầu khối kỵ binh xung phong vào đội hình Aegon. Ông chết trong ngọn lửa rồng cùng toàn bộ gia tộc." }
    },
    personalHooks: [
...
},
  {
    ...
    relationshipDetails: {
      ...
      "aegon-targaryen": { type: "Đối Thủ", trust: 10, affinity: 30, detail: "Sharra cầu hôn Aegon nhưng bị từ chối. Visenya bay rồng lên Eyrie và Ronnel đòi cưỡi rồng để đổi lấy sự quỳ gối." }
    },
...
father: "arryn-king-sharra",
...
},
  {
    ...
    legalStatus: "claimant",
    residenceIds: ["the-riverlands-seat"],
    claimRegionIds: ["the-riverlands"],
    religion: "Thất Diện Thần",
...
children: ["tully-son-edmyn"],
...
},
  {
    ...
    relationshipDetails: {
      "aegon-targaryen": { type: "Chủ", trust: 80, affinity: 60, detail: "Vickon được Aegon cho phép cai trị Quần Đảo. Ông là lãnh chúa được bầu, trung thành với ngôi sắt." }
    },
      startRegions: [],
      startHoldings: [],
...
},
  {
    ...
    allies: [],
    relationshipDetails: {
      "aegon-targaryen": { type: "Kẻ Thù", trust: 0, affinity: 0, detail: "Meria từ chối quỳ gối dù rồng thiêu đốt khắp Dorne. Bà là người duy nhất khẩu hiệu 'Unbowed, Unbent, Unbroken' đúng nghĩa." },
...
},
  {
    ...
    legalStatus: "heir",
    residenceIds: ["dorne-seat"],
    claimRegionIds: ["dorne"],
    religion: "Thất Diện Thần",
