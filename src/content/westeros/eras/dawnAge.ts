...
export const dawnAgeCharacters: CanonCharacter[] = [
  {
    ...
    equipment: [], items: [{ ten: "Vàng Casterly", soLuong: 100000, moTa: "Khởi đầu của huyền thoại" }], gold: 100000, startHoldings: ["the-westerlands-seat"], startRegions: ["the-westerlands"]
  },
  {
    ...
    equipment: [{ slot: "Vương Miện", ten: "Vương miện hoa lá", phamChat: "Vô Giá", thuocTinh: { "Tôn Trọng": 10 }, moTa: "Được đan từ dây leo" }], items: [], gold: 10000, startHoldings: ["the-reach-seat"], startRegions: ["the-reach"]
  },
  {
    ...
    equipment: [{ slot: "Vũ Khí Chính", ten: "Búa Vua Bão", phamChat: "Thượng Hạng", thuocTinh: { "Sát Thương Cận": 8 }, moTa: "Đập tan cơn bão" }], items: [], gold: 5000, startHoldings: ["the-stormlands-seat"], startRegions: ["the-stormlands"]
  },
  {
    ...
    equipment: [{ slot: "Vương Miện", ten: "Vương miện gỗ lũa", phamChat: "Vô Giá", thuocTinh: { "Tôn Trọng": 10 }, moTa: "Vương miện của Đảo Sắt" }], items: [], gold: 2000, startHoldings: ["the-iron-islands-seat"], startRegions: ["the-iron-islands"]
  },
  {
    ...
    equipment: [{ slot: "Vũ Khí Chính", ten: "Thương hai đầu", phamChat: "Tinh Xảo", thuocTinh: { "Sát Thương Cận": 7 }, moTa: "Xoay tít như cối xay" }], items: [], gold: 0
  }
];
