...
export const windsOfWinterCharacters: CanonCharacter[] = [
  {
    ...
    equipment: [{ slot: "Vũ Khí Chính", ten: "Rìu chiến lớn", phamChat: "Tinh Xảo", thuocTinh: { "Sát Thương Cận": 6 }, moTa: "Vũ khí của Tormund" }], items: [], gold: 10, startingHookIds: [],
    allies: ["jon-snow-resurrected", "mance-rayder"]
  },
  {
    ...
    equipment: [{ slot: "Vũ Khí Chính", ten: "Kiếm thép thường", phamChat: "Tinh Xảo", thuocTinh: { "Sát Thương Cận": 5 }, moTa: "Kiếm tốt" }], items: [], gold: 100, startingHookIds: [],
    spouse: "dalla",
    allies: ["tormund-giantsbane"],
    rivals: ["stannis-baratheon", "jon-snow-resurrected"]
  },
  {
    ...
    equipment: [], items: [{ ten: "Hồng ngọc", soLuong: 1, moTa: "Tỏa sáng kỳ ảo" }], gold: 500, startingHookIds: [],
    allies: ["stannis-baratheon", "jon-snow-resurrected"]
  },
  {
    ...
    equipment: [], items: [{ ten: "Sách cũ", soLuong: 3, moTa: "Người bạn duy nhất" }], gold: 200, startingHookIds: [],
  ...
  },
  {
    ...
    equipment: [{ slot: "Vũ Khí Chính", ten: "Rìu khổng lồ", phamChat: "Thượng Hạng", thuocTinh: { "Sát Thương Cận": 7 }, moTa: "Rìu của Kraken" }, { slot: "Giáp Thân", ten: "Giáp tấm Đảo Sắt", phamChat: "Tinh Xảo", thuocTinh: { "Phòng Thủ": 5 }, moTa: "Chìm nghỉm nếu rơi xuống nước" }], items: [], gold: 1000, startingHookIds: [], startArmy: { size: 3000, quality: "Thành Thạo" },
  ...
  },
  {
    ...
    equipment: [], items: [{ ten: "Dao găm thép Valyria", soLuong: 1, moTa: "Nguồn gốc của nội chiến" }], gold: 30000, startingHookIds: [],
    spouse: "lysa-arryn",
    allies: ["sansa-stark"],
    rivals: ["varys"]
  },
  {
    ...
    equipment: [], items: [{ ten: "Lưới gián điệp", soLuong: 1, moTa: "Khắp mọi nơi" }], gold: 10000, startingHookIds: [],
    allies: ["daenerys-targaryen-queen"],
  ...
  },
  {
    ...
    equipment: [{ slot: "Vũ Khí Chính", ten: "Kiếm thép lớn", phamChat: "Thượng Hạng", thuocTinh: { "Sát Thương Cận": 6 }, moTa: "Vung bằng một tay" }], items: [], gold: 100, startingHookIds: [],
