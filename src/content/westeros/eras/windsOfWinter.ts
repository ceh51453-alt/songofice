...
export const windsOfWinterCharacters: CanonCharacter[] = [
...
},
  {
    ...
    equipment: [], items: [{ ten: "Hồng ngọc", soLuong: 1, moTa: "Tỏa sáng kỳ ảo che giấu thân phận thật" }], gold: 500, startingHookIds: [],
...
},
  {
    ...
    equipment: [], items: [{ ten: "Dao găm thép Valyria", soLuong: 1, moTa: "Nguồn gốc của nội chiến" }], gold: 50000, startingHookIds: [],
    spouse: "lysa-tully",
    allies: ["sansa-stark"],
...
},
  {
    ...
    equipment: [], items: [{ ten: "Lưới gián điệp", soLuong: 1, moTa: "Khắp mọi nơi" }], gold: 15000, startingHookIds: [],
