...
export const windsOfWinterCharacters: CanonCharacter[] = [
  {
    ...
    origin: "Thủ lĩnh của người Tự Do phía bắc Bức Tường, đồng minh quan trọng của Jon Snow sau khi Mance bị đánh bại.", culture: "Người Tự Do", bloodline: "Không xác minh", continent: "Westeros", appearance: "Người đàn ông khổng lồ, tóc đỏ, râu đỏ rậm và nụ cười rộng; các thành tích phi thường thường do chính ông phóng đại.",
...
},
  {
    ...
    origin: "Cựu huynh đệ Tuần Đêm mang nửa dòng người Tự Do, rời Bức Tường và thống nhất nhiều bộ tộc làm King-beyond-the-Wall.", culture: "Người Tự Do; từng thuộc Tuần Đêm", bloodline: "Không xác minh", continent: "Westeros", appearance: "Người đàn ông tầm trung, tóc nâu sẫm có điểm bạc và mắt xám; mặc áo choàng chắp vá đen-đỏ.",
...
},
  {
    ...
    origin: "Nữ tư tế đỏ của R'hllor, tự xưng là Melisandre of Asshai; trước khi đến Bức Tường bà đã ủng hộ Stannis tại Dragonstone.", culture: "Asshai'i", bloodline: "Không xác minh", continent: "Essos", appearance: "Cao, mảnh, tóc đỏ đồng và mắt đỏ; vẻ trẻ trung gắn với vòng cổ ruby ma thuật.",
...
},
  {
    ...
    origin: "Em trai Balon và Euron Greyjoy, Lord Captain of the Iron Fleet được Euron phái đi Meereen tìm Daenerys.", culture: "Người Sắt", bloodline: "Nhà Greyjoy", continent: "Westeros", appearance: "Rất to lớn, tóc đen, râu rậm và mắt xám thép; bàn tay bị thương thường được che bằng găng sắt.",
...
},
  {
    ...
    origin: "Con trai Lewyn Martell và Lady Princess of Dorne, Prince of Dorne, anh trai Elia và Oberyn, cha Arianne, Quentyn và Trystane.", culture: "Dornish Rhoynar", bloodline: "Nhà Nymeros Martell", continent: "Westeros", appearance: "Một người đàn ông béo, đau khớp nặng, phải dùng xe lăn; gương mặt tái nhợt và đôi mắt u buồn.",
...
},
  {
    ...
    origin: "Con gái cả Doran Martell và Mellario of Norvos, người thừa kế Sunspear theo luật kế vị Dornish.", culture: "Dornish Rhoynar", bloodline: "Nhà Nymeros Martell và Norvos", continent: "Westeros", appearance: "Da màu ô liu, tóc đen xoăn, mắt nâu sẫm và vóc người đầy đặn; có nét đẹp cổ điển của Dorne.",
...
},
  {
    ...
    origin: "Con trai của một lãnh chúa rất nhỏ vùng Fingers, được Hoster Tully nuôi dạy ở Riverrun; Master of Coin rồi Lord Protector of the Vale.", culture: "Người Vale", bloodline: "Nhà Baelish", continent: "Westeros", appearance: "Người đàn ông nhỏ nhắn, tóc đen có điểm xám, râu nhọn và đôi mắt xanh xám hay cười.",
...
},
  {
    ...
    origin: "Thái giám gốc Lys, từng là diễn viên và kẻ trộm trước khi trở thành Master of Whisperers ở King's Landing.", culture: "Lysene", bloodline: "Không xác minh", continent: "Essos", appearance: "Béo, hói, da mềm và giọng nói dịu; không để râu và thường mặc đồ lụa thơm.",
...
},
  {
    ...
    origin: "Em trai Ser Gregor Clegane, từng là hộ vệ của Joffrey Baratheon trước khi bỏ chạy sau Blackwater.", culture: "Người miền Tây", bloodline: "Nhà Clegane", continent: "Westeros", appearance: "Rất cao và lực lưỡng; nửa mặt trái bị bỏng nặng từ thời thơ ấu, tóc đen và râu lởm chởm.",
