...
const COASTLINES: Partial<Record<string, MapPoint[]>> = {
  westeros: [
    // Bờ bắc (Wall area) — tương đối thẳng
    [92, 0], [170, 3], [250, 0], [330, 5], [420, 0], [510, 8], [600, 2], [710, 6], [822, 0],
    // Bờ đông bắc (Skagos → White Knife)
    [872, 38], [842, 82], [806, 116], [826, 166], [792, 214], [812, 270],
    [778, 328], [802, 382],
    // The Fingers & Vale peninsula — jut east but not so far as to swallow Dragonstone
    [762, 415], [815, 440], [870, 460], [920, 470], [930, 500],
    [910, 530], [918, 560],
    // Bay of Crabs (concavity between Vale & Crackclaw) — pull coast west here
    [900, 580], [870, 600], [860, 620], [870, 640],
    // Crackclaw Point protrusion
    [830, 660], [800, 685], [790, 700],
    // Blackwater Bay — coast stays WEST of Dragonstone [835,750]
    [808, 720], [810, 740], [815, 760], [820, 780], [808, 800],
    // Kingswood coast → Stormlands
    [830, 830], [850, 860], [870, 900], [880, 930],
    // Storm's End coast → Cape Wrath
    [860, 958], [888, 1016], [850, 1068], [818, 1112],
    // Tarth & southern Stormlands
    [842, 1100], [870, 1130], [884, 1204],
    // Dorne — bờ đông (Boneway area)
    [900, 1260], [880, 1300], [860, 1330],
    // Dorne cực đông — mũi Sunspear
    [840, 1370], [780, 1410], [720, 1440], [650, 1458],
    // Dorne — bờ nam (từ Sunspear → Starfall)
    [548, 1470], [480, 1465], [420, 1455], [360, 1442],
    // Dorne tây nam — quanh Starfall
    [300, 1420], [260, 1390], [232, 1360],
    // Bờ tây (Reach coast — Oldtown area)
    [210, 1300], [226, 1238], [194, 1182], [166, 1120],
    // Shield Islands area
    [176, 1058], [142, 1004], [124, 932],
    // Reach → Westerlands coast
    [142, 866], [132, 802], [150, 740],
    // Lannisport / Casterly Rock area
    [164, 680], [174, 620], [196, 574],
    // Iron Islands gap (bờ tây Westeros nhìn ra Iron Islands)
    [215, 555], [254, 550], [300, 540], [334, 536],
    // Bờ tây bắc (Cape Kraken → Flint Cliffs)
    [374, 506], [350, 474], [302, 448],
    // Stony Shore area
    [244, 426], [210, 382], [194, 322],
    // Bờ tây xa bắc
    [174, 270], [182, 214], [150, 160], [136, 104], [112, 58],
  ],
  essos: [
